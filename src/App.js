...
import { SecondBlockItem } from "components/item";
          ...
          <div className={styles.main}>
            <div className={styles.header}>
              ...
              <div className={styles.header__navbar}>
                <p className={styles.header__link}>Как это работает</p>
                <p className={styles.header__link}>3-й блок</p>
                <p className={styles.header__link}>Вопросы и ответы</p>
                <p className={styles.header__link}>Форма</p>
              </div>
